                ...
                <fieldset class="layui-elem-field layui-field-title" style="margin-top: 0px; padding: 5px">
                    ...
                    <form class="layui-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="cust_name" placeholder="请输入姓名" autocomplete="off" class="layui-input">
                            </div>
...
function refresh(){
    layui.use('table', function(){
      ...
      table.render({
        elem: '#demo'//绑定容器
        ,url: con.app+'/cus/getcustlist' //数据接口//默认会自动传递两个参数：?page=1&limit=30
        ,height: 'full-230'//容器高度
        ,request: {
          pageName: 'pageIndex' //页码的参数名称，默认：page
          ,limitName: 'pageLimit' //每页数据量的参数名，默认：limit
        }   
        ,where:{cust_code:$("input[name='cust_code']").val(),cust_name:$("input[name='cust_name']").val()}
        ,page: true //开启分页
        ,cols: [[ //表头
          {title: '全选',type:'checkbox',fixed: 'left'}//LAY_CHECKED:true
          ,{title: '序号', type:'numbers', fixed: 'left'}
          ,{field: 'id', title: '主键ID', width:80, sort: true, fixed: 'left',align:'right'}
          ,{field: 'cust_code', title: '账号', width:120}
          ,{field: 'cust_name', title: '姓名', width:120, sort: true}
